...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726143833147.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726162746744.png)
...
如果f(x)不等于f(-x) 这个部分，这个时候我们就说什么，我们就说函数。非奇非偶函数
...
<u>偶函数大家都知道。偶函数是关于Y轴对称。</u><u>如果是奇函数，关于原点对称。</u>
...
![image-20250103131447789](/Users/yuebinghui/Documents/program/github/note/images/image-20250103131447789.png)

![image-20250103131615588](/Users/yuebinghui/Documents/program/github/note/images/image-20250103131615588.png)
...
######  🤯  这两个式子是表达的是同样的意思吗?-分式不等式

<a href="/Users/yuebinghui/Documents/program/github/note/笔记/数学/初高中数学/1.1解不等式.md#分式不等式">分式不等式</a>点击跳转看这里的解答，是一个意思

![image-20250103132958206](/Users/yuebinghui/Documents/program/github/note/images/image-20250103132958206.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240911101438389.png)

###### 🤯 奇函数  

![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726175756449.png)*等于![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726175811682.png)。函数是个奇函数，2 3 4是奇函数，1是偶函数*



记住它。你将来会经常会碰到他。你将来会经常会碰到函数。函数非常的重要。
尤其是第一个函数。第二个函数，第四个函数，这是经常考的。

![image-20250103135059383](/Users/yuebinghui/Documents/program/github/note/images/image-20250103135059383.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726182337780.png)
...
<u>那么接下来我们来看看。在这一块当中，比如说我们看这是F(x)等于F(-x)。</u>(这是偶函数的情况)
这是个偶函数的话，你可以求个导。会求吗？
这个求导？我们先对中间变量求导。中间变量再求导。

*然后对F(x)等于F(-x)，两边同时求导，得出第二行第一个的等式*，
*然后两边同乘负1，得出了第二行的第三个式子，*
*即标准判断奇函数的情况，不懂看🤯 判断函数的奇偶性*
...
![image-20250104115954402](/Users/yuebinghui/Documents/program/github/note/images/image-20250104115954402.png)

![image-20250104120004878](/Users/yuebinghui/Documents/program/github/note/images/image-20250104120004878.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240726204554127.png)
...
*他这样说的。对于任意的一个X，属于一个区间i。存在一个数M大于零。*
*然后使得你这个区间内的所有的函数值的绝对值小于等于M，*
*成立。我就说这个函数在区间i内有界*
...
*只要说有界，一定要跟区间挂钩*
*请注意，如果没有说有没有界，就指的是定义域的范围内有界。你在整个定义域范围内你是有界的。*
*(比如1/x，在1到正无穷有界，在0到1就没有界了)*

###### 🤯 绝对值

就可以按照x的正负把，绝对值符号去掉，
即当x大于等于0的时候是x本身
当x小于0的时候是负x，然后解不等式就可以了
就可以列出和有绝对值符号的不等式一样的不等式，不过是去掉了绝对值符号的

![image-20250105095605482](/Users/yuebinghui/Documents/program/github/note/images/image-20250105095605482.png)

x小于等于一个数，指的是一个区间

![image-20250307164224414](/Users/yuebinghui/Documents/program/github/note/images/image-20250307164224414.png)
...
### 🤯 sin
sinx对比斜
![image-20250105100623987](/Users/yuebinghui/Documents/program/github/note/images/image-20250105100623987.png)

### 🤯 cos
cosx邻比斜
![image-20250105102448523](/Users/yuebinghui/Documents/program/github/note/images/image-20250105102448523.png)

###### 🤯 利用已知三角函数的特殊值值推出其他值

A=2kπ＋120°。

cosA=-1/2 = -cos60° = cos(180°-60°) = cos120°

![image-20250105102409241](/Users/yuebinghui/Documents/program/github/note/images/image-20250105102409241.png)

![image-20250105102331342](/Users/yuebinghui/Documents/program/github/note/images/image-20250105102331342.png)

![image-20241205191028669](/Users/yuebinghui/Documents/program/github/note/images/image-20241205191028669.png)
...
###### 🤯 tan
tanx对比邻
![image-20250526082011828](/Users/yuebinghui/Documents/program/github/note/images/image-20250526082011828.png)

tan所以说它是无界函数。没有界你在二分之π的时候到无穷大，负二分之π的到负无穷

---

###### 🤯 cot
cotx邻比对
![image-20250105102913596](/Users/yuebinghui/Documents/program/github/note/images/image-20250105102913596.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240724200235532.png)
...
*这里符号的正负看的是原来没变之前的函数，的象限来判正负，*
*就比如sin(π/2+x)，这里首先π/2是奇，奇变，变成cos，然后看sin(π/2+x)在第2象限，*
*所以直接就是cosx就可以了，没有变符号，因为看的是原来没变之前的函数，的象限来判正负*
奇变偶不变中的奇变指的是sin(π/2+x)中的*π/2*常数的奇偶性
...
sin cos tan在各个象限中的正负，
首先是sin，看的是y轴的上半部分，是正的，所以1 2象限是正的，
其次是cos，看的是x轴的右边半部分，是正的，所以1 4象限是正的，
最后是tan，tan的话就是sin/cos，所以sincos第一象限是正的，tan就是正，sincos在第三象限都为负，负负得正所以tan在第三象限就是正的，忘记了就画画sin cos在四个象限中的正负就推出tan的了
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240724204917719.png)![](/Users/yuebinghui/Documents/program/github/note/images/image-20240724204911369.png)

*tan那二分之π是不存在的，所以就没有。你给❌掉。这不叫无穷大叫不存在。*
**求极限才是无穷大。直接代进去的是不存在**

tan π/6 是3分之根号3   也是根号3 分之1，因为你上下同乘个根号3就变成前面的值了

<img src="/Users/yuebinghui/Documents/program/github/note/images/image-20240724204743620.png" style="zoom:25%;" />
...
![image-20250105104037902](/Users/yuebinghui/Documents/program/github/note/images/image-20250105104037902.png)
...
![image-20250105132258990](/Users/yuebinghui/Documents/program/github/note/images/image-20250105132258990.png)
...
###### 🤯 降幂公式推导（是由倍角公式推出来的）
![image-20250626112709481](/Users/yuebinghui/Documents/program/github/note/images/image-20250626112709481.png)
...
![image-20250307075424938](/Users/yuebinghui/Documents/program/github/note/images/image-20250307075424938.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240727102552866.png)
...
所以在这里面当中我专门把定义写出来
<u>你不要说arcsin是sin的反函数，这句话是错的。</u>

<u>人家说什么？y等于sinx在哪个区间？
<u>在区间负的二分之π到二分之π内的反函数。这个区间内的反函数才叫arcsin。</u>
<u>2这一段有没有反函数，有，</u>
<u>你的反函数名字叫arcsin吗？不叫。</u>

一定要理解清楚一个事情sin在负二分之π到二分之π内的反函数。这个图像怎么画？非常简单，
这是负二分之π。然后这是二分之π？然后这是一？然后这是负一？

你都知道*反函数跟原函数关于y=x对称*吧？图像它是这样。
*这个定义域和值域要做调换。你的值域是负一到一，我定义域域是负一到一。*
*你的定义域是负二分之π到二分之π，我的值域是负二分之π到二分之π。*能听懂我的意思吗？

<u>arcsin不是说是sin的反函数
是sin在哪一段，是sin在负二分之π到二分之π的这一段的反函数。</u>
<u>而且。反函数跟原来函数具有相同的单调性</u>

![](/Users/yuebinghui/Documents/program/github/note/images/image-20240725092240018.png)

![image-20250106111329877](/Users/yuebinghui/Documents/program/github/note/images/image-20250106111329877.png)
...
没有了。如果合起来它就不单调了。<u>什么叫单调呢？</u>*跑上去它又下来了就不单调了*。所以这样它就没有反函数了。
...
我来给大家。出一个函数。比如说。这就是我们的Sinx这个函数？没问题吧。
Sinx这条曲线。那接下来我在这一块当中。来给你来了条横线。这条横线是Y等于A？
...
arccos那是cos在哪一段的反函数呢？
cos图像0到π有反函数
把cos0到π的反函数叫arccos。所以定义域和值域做交换。
你cos的值域是负一到一，我arccos的定义域域是负一到一。
你cos的定义域是0到π，我arccos的值域是0到π。
你是减函数，我也是减函数，
...
![image-20250106111300863](/Users/yuebinghui/Documents/program/github/note/images/image-20250106111300863.png)
...
这里面当中还有一个著名的等式叫做<u>arcsin+arccos</u>等于多少？，
他的结果是一个常数。

我先把函数设出来。这是arcsin然后再加上arccos。
怎么证明。

导函数为零它就是个常数。你不信，
求下导？值是根号下一减x方分之一，再求导，根号下一减X方分之1添负号。
所以说两项求导等于零。
你求导等于零不就说明这是个C是常数吗
...
什么叫常数？常数非常简单。你看，
*比如说一个函数是个常数。常数的意思。无论我x为多少，你值都是相等的。*
无论你为多少，

所以我就稍微的进行求一下，
那我就求一下零看看。零处值，一处值，二处值跟任何处值它都是一样的。
...
请注意是tan这一段的反函数。
是负二分之π到二分之π内的反函数，这一段的反函数才叫arctan。
你必须要记住。图像是重点。
所以在这里面当中，1这是二分之π。2这是负二分之π。图像要记住。

![](/Users/yuebinghui/Documents/program/github/note/images/image-20240725114008722.png)

比如说举个例子。我想问你arctan1等于多少？你就要在负二分之π到二分之π内找。tan多少等于一？
tan四分之π等于1
...
![image-20250106111813804](/Users/yuebinghui/Documents/program/github/note/images/image-20250106111813804.png)
...
![image-20250106111903460](/Users/yuebinghui/Documents/program/github/note/images/image-20250106111903460.png)
...
![](/Users/yuebinghui/Documents/program/github/note/images/image-20240823150653122.png)

![](/Users/yuebinghui/Documents/program/github/note/images/image-20240908182101456.png)
...
这个内容它叫做形如log以a为底X的对数，读作log以a为底X的对数。
这几种对数函数其实你都知道，对数函数不太喜欢考这个人。
不太喜欢考样子，在考研中。
...
log以e为底的x的对数。
把它写成y=lnx，e我刚才讲过2.78约等于。所以说它是单调增的。
...
![image-20250217120444849](/Users/yuebinghui/Documents/program/github/note/images/image-20250217120444849.png)

![image-20250217120500421](/Users/yuebinghui/Documents/program/github/note/images/image-20250217120500421.png)

![image-20250109154438748](/Users/yuebinghui/Documents/program/github/note/images/image-20250109154438748.png)

![](/Users/yuebinghui/Documents/program/github/note/images/image-20240725132727300.png)

![image-20241014175101845](/Users/yuebinghui/Documents/program/github/note/images/image-20241014175101845.png)
...
接下来我们再看下面一个问题，叫做幂函数。这是个重点。它是一个核心考点。也是个难点。那么讲幂函数我经常会给你讲。
它X的$\alpha$次方。你注意一个事情，幂函数。它可以分布在第一象限。它可以分布在第二象限。它可以分布在第三象限，它绝对不能分布在第四象限。
...
![image-20250106113705330](/Users/yuebinghui/Documents/program/github/note/images/image-20250106113705330.png)

![image-20240725152957184](/Users/yuebinghui/Documents/program/github/note/images/image-20240725152957184.png)

![image-20241026143156692](/Users/yuebinghui/Documents/program/github/note/images/image-20241026143156692.png)

![image-20241026144017329](/Users/yuebinghui/Documents/program/github/note/images/image-20241026144017329.png)
