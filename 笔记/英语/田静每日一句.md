...
如果大家会写一个普通的句子，那么把它一拆，两半儿往强调句里一塞，立刻就变成了强调句，那怎么一拆两半儿呢？其实就是把一个普通句子当中要强调的部分。放到it was that中间儿句子的余切部分往后一扔，哎，这个时候强调句就写成了，而且强调句还有一个重要的特点就在于什么呢？就是它是从一个完整的句子变过来的。所以当你把这个it was that给它去掉之后，这个句子仍然能还原成完整的样子。

而且呢，碰巧赶上这句话当中强调的正好是句子的主语部分，所以呢，你把这个h boss that去掉之后，哎，这正好顺理成章的变成了主谓的一句话
