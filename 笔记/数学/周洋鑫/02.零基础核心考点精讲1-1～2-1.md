...
![image-20240726162039358](/Users/yuebinghui/Documents/program/github/note/images/image-20240726162039358.jpg)如果对于一个区间内。我写个区间D。对于任意的x属于一个区间。x在这个区间内。我就可以通过一个对应法则。通过运算性的法则。有一个唯一的Y与之确定。
